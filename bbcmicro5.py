...
#   BBC Micro (Mode 5) Image Filter - BBC Micro plugin for The GIMP.
...
#   sdlbasic version: bbcmicro_mode2_PictFilter_1011070220.sdlbas
...
def bbcmicro5(img, layer, strength, serpent, dither):
    ...
    # Initialise progress bar
    gimp.progress_init("BBC Micro (Mode 5) Image Filter")
...
register("python-fu-bbcmicro5",
         N_("BBC Micro (Mode 5) Image Filter"),
         "",
         "Nitrofurano",
         "Nitrofurano",
         "2008",
         N_("_BBC Micro (Mode 5)"),
         "RGB*",
