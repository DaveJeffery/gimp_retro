...
#   Amstrad CPC (Mode 0) Image Filter - Amstrad CPC plugin for The GIMP.
...
def amstradcpc0(img, layer, strength, serpent, dither):
    ...
    # Initialise progress bar
    gimp.progress_init("Amstrad CPC (Mode 0) Image Filter")
...
register("python-fu-amstradcpc0",
         N_("Amstrad CPC (Mode 0) Image Filter"),
         "",
         "Nitrofurano",
         "Nitrofurano",
         "2008",
         N_("_Amstrad CPC (Mode 0)"),
         "RGB*",
