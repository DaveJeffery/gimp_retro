...
#   BBC Micro (Mode 2) Image Filter - BBC Micro plugin for The GIMP.
...
def bbcmicro2(img, layer, strength, serpent, dither):
    ...
    gimp.progress_init("BBC Micro (Mode 2) Image Filter")
...
register("python-fu-bbcmicro2",
         N_("BBC Micro (Mode 2) Image Filter"),
         "",
         "Nitrofurano",
         "Nitrofurano",
         "2008",
         N_("_BBC Micro (Mode 2)"),
         "RGB*",
