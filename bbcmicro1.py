...
#   BBC Micro (Mode 1) Image Filter - BBC Micro plugin for The GIMP.
...
def bbcmicro1(img, layer, strength, serpent, dither):
    ...
    # Initialise progress bar
    gimp.progress_init("BBC Micro (Mode 1) Image Filter")
...
register("python-fu-bbcmicro1",
         N_("BBC Micro (Mode 1) Image Filter"),
         "",
         "Nitrofurano",
         "Nitrofurano",
         "2008",
         N_("_BBC Micro (Mode 1)"),
         "RGB*",
